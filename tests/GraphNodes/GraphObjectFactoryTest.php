...
class GraphObjectFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $shouldPassOne = GraphObjectFactory::isCastableAsGraphList(array());
        $shouldPassTwo = GraphObjectFactory::isCastableAsGraphList(array('foo', 'bar'));
        $shouldFail = GraphObjectFactory::isCastableAsGraphList(array('faz' => 'baz'));
